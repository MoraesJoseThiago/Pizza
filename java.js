...
let bntEstorno = document.getElementById('estorno');
let bntPlanilha = document.getElementById('export');

//eventos
btnVendas.addEventListener('click',venda,false);
bntEstorno.addEventListener('click',estorno,false);
bntPlanilha.addEventListener('click',planilha,false);

//funções de VENDAS
function venda(e){
    if(document.getElementById('mussarela').checked){
        somaMussarela = somaMussarela + 1;
        vendaMussarela = vendaMussarela + 24.00;
